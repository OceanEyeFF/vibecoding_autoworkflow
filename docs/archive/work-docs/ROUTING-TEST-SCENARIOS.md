---
title: "ROUTING-TEST-SCENARIOS.md"
status: archived
updated: 2026-03-17
owner: aw-kernel
...
3. **文档引用**：
   ...
   - `/autodev` Skill（`toolchain/skills/aw-kernel/autodev/SKILL.md`）为主入口

## 结果汇总
- 场景总数：6
- 通过：6
- 未通过：0
- 结论：✅ 所有场景通过（以 `GUIDE.md` Part 2 为基准）
- 验证日期：2026-01-20
