...
| Agent | 文件 | 何时使用 | 预计耗时 |
|-------|------|---------|----------|
| **feature-shipper** | [feature-shipper.md](../../../toolchain/agents/aw-kernel/ship.md) | 实现具体功能 | 1-2 小时 |
| **code-analyzer** | [code-analyzer.md](../../../toolchain/agents/aw-kernel/review.md) | 代码结构分析 | 10-30 分钟 |
| **code-debug-expert** | [code-debug-expert.md](../../../toolchain/agents/aw-kernel/logs.md) | 问题定位与修复 | 30-60 分钟 |
| **requirement-refiner** | [requirement-refiner.md](../../../toolchain/agents/aw-kernel/clarify.md) | 需求澄清细化 | 15-30 分钟 |
| **code-project-cleaner** | [code-project-cleaner.md](../../../toolchain/agents/aw-kernel/clean.md) | 代码清理重构 | 30-60 分钟 |
| **system-log-analyzer** | [system-log-analyzer.md](../../../toolchain/agents/aw-kernel/logs.md) | 日志分析诊断 | 20-40 分钟 |
...
|---------|------|---------|---------|--------|
| **新功能开发** | L1 | [WORKFLOW.md](../../../toolchain/skills/aw-kernel/autodev/SKILL.md) | [autodev/SKILL.md](../../../toolchain/skills/aw-kernel/autodev/SKILL.md) | 需要完整流程时 |
| **单个功能实现** | L1 | [feature-shipper.md](../../../toolchain/agents/aw-kernel/ship.md) | - | 需求已明确时 |
| **代码分析** | L1 | [code-analyzer.md](../../../toolchain/agents/aw-kernel/review.md) | - | 需要架构评估时 |
| **调试问题** | L1 | [code-debug-expert.md](../../../toolchain/agents/aw-kernel/logs.md) | [system-log-analyzer.md](../../../toolchain/agents/aw-kernel/logs.md) | 遇到 Bug 时 |
| **需求澄清** | L1 | [requirement-refiner.md](../../../toolchain/agents/aw-kernel/clarify.md) | - | 需求模糊时 |
| **代码清理** | L1 | [code-project-cleaner.md](../../../toolchain/agents/aw-kernel/clean.md) | - | 需要重构时 |
