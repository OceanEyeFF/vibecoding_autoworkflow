---
title: "Claude Code Agent 设计基线索引"
status: archived
updated: 2026-03-17
owner: aw-kernel
...
- 当前协作指南：[`docs/overview/guide.md`](../../../overview/guide.md)
- 当前路线图：[`docs/overview/roadmap.md`](../../../overview/roadmap.md)
- 当前任务台账：[`docs/planning/WORKBOARD.md`](../../../planning/WORKBOARD.md)
- 分析精华（失败模式与改进条目）：[`docs/knowledge/analysis/autodev-insights.md`](../../../knowledge/analysis/autodev-insights.md)
...
**归档文件**：
- [IDEA-001: SubAgent 调用机制](../../../ideas/archived/IDEA-001-subagent-call-mechanism.md)
- [IDEA-002: Agent 边界定义](../../../ideas/archived/IDEA-002-agent-boundary-definition.md)
- [IDEA-003: 鉴权 Agent](../../../ideas/archived/IDEA-003-permission-guard-agent.md)
- [IDEA-004: 结构化交互协议](../../../ideas/archived/IDEA-004-structured-interaction-protocol.md)
...
|------|------|-------|---------|------|------|
| IDEA-001 | [SubAgent 调用机制](../../../ideas/archived/IDEA-001-subagent-call-mechanism.md) | - | P01 | 📦 已归档 | 不兼容 ClaudeCode，见[可行方案](#clauecode-兼容的协作方案) |
| IDEA-002 | [Agent 职责边界定义](../../../ideas/archived/IDEA-002-agent-boundary-definition.md) | - | P02 | 📦 已归档 | 不兼容 ClaudeCode，见[可行方案](#clauecode-兼容的协作方案) |
| IDEA-003 | [鉴权 Agent 设计](../../../ideas/archived/IDEA-003-permission-guard-agent.md) | - | P03 | 📦 已归档 | 不兼容 ClaudeCode，见[可行方案](#clauecode-兼容的协作方案) |
| IDEA-004 | [结构化交互协议](../../../ideas/archived/IDEA-004-structured-interaction-protocol.md) | - | P04 | 📦 已归档 | 不兼容 ClaudeCode，见[可行方案](#clauecode-兼容的协作方案) |
| IDEA-005 | [本地化文档缓存](../../../ideas/archived/IDEA-005-localized-instruction-cache.md) | P0 | P05 | 🔴 待实施 | 可行，待评估优先级 |
| IDEA-006 | [强制数据访问机制](../../../ideas/active/IDEA-006-mandatory-data-access.md) | P0 | P06 | ✅ 已完成 | 已广泛应用于 7 个 Agent |
...
### 问题诊断
- [分析精华（失败模式与改进条目）](../../../knowledge/analysis/autodev-insights.md)

### 归档文档
- [归档索引](archived/README.md)
- [IDEA-001: SubAgent 调用机制](../../../ideas/archived/IDEA-001-subagent-call-mechanism.md)（已归档）
- [IDEA-002: Agent 边界定义](../../../ideas/archived/IDEA-002-agent-boundary-definition.md)（已归档）
- [IDEA-003: 鉴权 Agent](../../../ideas/archived/IDEA-003-permission-guard-agent.md)（已归档）
- [IDEA-004: 结构化交互协议](../../../ideas/archived/IDEA-004-structured-interaction-protocol.md)（已归档）

### 可行实现
- [IDEA-005: 本地化文档缓存](../../../ideas/archived/IDEA-005-localized-instruction-cache.md)（可行，待评估）
- [IDEA-006: 强制数据访问机制](../../../ideas/active/IDEA-006-mandatory-data-access.md)（✅ 已完成）
