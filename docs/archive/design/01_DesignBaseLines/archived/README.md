...
### [IDEA-003: 鉴权 Agent（Permission-Guard）](../../../../ideas/archived/IDEA-003-permission-guard-agent.md)
...
- [IDEA-006: 强制数据访问机制](../../../../ideas/active/IDEA-006-mandatory-data-access.md)（已成功实施）
- [autodev Skill 实现](../../../../../toolchain/skills/aw-kernel/autodev/SKILL.md)
- [ship Agent](../../../../../toolchain/agents/aw-kernel/ship.md)（当前交付闭环示例）
