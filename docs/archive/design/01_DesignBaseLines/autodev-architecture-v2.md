...
```yaml
# toolchain/skills/aw-kernel/autodev/SKILL.md
---
name: autodev
...
```yaml
# toolchain/skills/aw-kernel/autodev-worktree/SKILL.md
---
...
- [x] 创建 `toolchain/skills/aw-kernel/autodev/SKILL.md`
...
- [x] 创建 `toolchain/skills/aw-kernel/autodev-worktree/SKILL.md`
- [ ] 实现 worktree 生命周期管理
- [ ] 测试并行开发场景
