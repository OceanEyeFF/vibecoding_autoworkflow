...
| 文件 | 修改内容 |
|------|---------|
| `toolchain/agents/aw-kernel/ship.md` | 替换工具纪律部分，添加输出格式 |
| `toolchain/agents/aw-kernel/clarify.md` | 同上 |
| `toolchain/agents/aw-kernel/review.md` | 同上 |
| `toolchain/agents/aw-kernel/debug (已删除).md` | 同上 |
| `toolchain/agents/aw-kernel/logs.md` | 保持 JSON 输出，添加 evidence 字段 |
...
| `toolchain/schemas/agent-output.json` | 输出格式 Schema |
