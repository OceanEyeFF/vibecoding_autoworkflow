---
title: "Claude Code Skill 设计基线：指令模块化管理"
status: archived
updated: 2026-03-17
owner: aw-kernel
...
**执行阶段**：
- Phase 1: `toolchain/skills/aw-kernel/autodev/phases/phase-1-refinement.md`
- Phase 2: `toolchain/skills/aw-kernel/autodev/phases/phase-2-planning.md`
- Phase 3: `toolchain/skills/aw-kernel/autodev/phases/phase-3-iteration.md`
- Phase 4: `toolchain/skills/aw-kernel/autodev/phases/phase-4-delivery.md`

**质量门禁**：
- G1-G4: `toolchain/skills/aw-kernel/autodev/gates/gate-{1-4}-*.md`

**多层回路**：
- Level 0-3: `toolchain/skills/aw-kernel/autodev/loops/loop-level-{0-3}-*.md`
...
如果任一项为 ❌：
1. Read("toolchain/skills/aw-kernel/autodev/phases/phase-1-refinement.md") 刷新指令
...
1. **每 5 轮对话**
   - 强制读取当前 Phase 的指令文件
   - 例如：Read("toolchain/skills/aw-kernel/autodev/phases/phase-2-planning.md")
...
SKILL_DIR="toolchain/skills/aw-kernel/autodev"
...
### 优先级 2（后续优化）
- 创建 `toolchain/skills/_shared/` 目录存放跨 Skill 共享指令
- 编写脚本自动生成模块化目录结构
...
- 待修改：`toolchain/skills/aw-kernel/autodev/SKILL.md`（精简并添加启动协议）
- 待创建：`toolchain/skills/aw-kernel/autodev/phases/*.md`（Phase 详细指令）
- 待创建：`toolchain/skills/aw-kernel/autodev/gates/*.md`（Gate 检查清单）
- 待创建：`toolchain/skills/aw-kernel/autodev/loops/*.md`（Loop 策略）
- 可选创建：`toolchain/skills/_shared/*.md`（跨 Skill 共享指令）
