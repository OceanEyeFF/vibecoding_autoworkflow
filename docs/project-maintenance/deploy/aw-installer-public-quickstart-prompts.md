...
- current_install_source:
  - published_registry: `aw-installer@next` currently resolving to `0.4.3-rc.0`
  - local_candidate: local `0.4.3-rc.1` `.tgz` candidate package
