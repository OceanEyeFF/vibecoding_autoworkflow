...
12. `docs/harness/README.md` 与关键子入口是否仍存在，并继续链接 foundations / scope / artifact / adjacent-systems / workflow-families；`docs/deployable-skills/README.md` 是否已明确降为 transition 入口
