...
- [Harness 合同模板：harness-contract-template](operations/prompt-templates/harness-contract-template.json)
...
- [仓库治理评估：repo-governance-evaluation](operations/prompt-templates/repo-governance-evaluation.md)
