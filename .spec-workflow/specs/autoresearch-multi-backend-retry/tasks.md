...
- [ ] 1. Extend autoresearch contract schema and loader for backend/retry settings
...
- [ ] 2. Make P2 preflight validate configured backend expectations instead of hardcoded codex-only rules
...
- [ ] 3. Introduce a shared backend phase executor with retry-aware normalized outcomes
...
- [ ] 4. Implement the OpenCode backend MVP on top of the shared backend interface
...
- [ ] 5. Add worker backend routing and retry-aware execution to the autoresearch loop wrapper
...
- [ ] 6. Forward contract-driven retry settings through autoresearch baseline and round suite launches
...
- [ ] 7. Update runner-facing documentation for backend selection and retry policy
...
- [ ] 8. Update analysis/observability documents to reflect OpenCode activation and retry metadata
