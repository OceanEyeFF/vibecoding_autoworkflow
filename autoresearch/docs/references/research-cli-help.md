...
```bash
python3 autoresearch/src/manage_tmp_exrepos.py
```
...
- [Codex Repo-local Usage Help](../../../docs/project-maintenance/usage-help/codex.md)
- [Task Interface / Memory Side Usage Help 总入口](../../../docs/project-maintenance/usage-help/README.md)
