...
- `autoresearch/src/run_skill_suite.py`
- `autoresearch/src/run_claude_skill_eval.py`
- `autoresearch/src/backends/`
...
- live acceptance matrix：`autoresearch/src/run_backend_acceptance_matrix.py` 固定跑 `codex -> codex` 与 `claude -> codex`，并对四个 skills 全量执行 `task: all`
