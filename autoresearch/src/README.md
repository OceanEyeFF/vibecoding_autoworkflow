...
- `python3 autoresearch/src/run_autoresearch.py refresh-status`
  - 重建 `.autoworkflow/autoresearch/run-status-index.json`
  - 重建 `.autoworkflow/autoresearch/skill-training-status.json`
- `python3 autoresearch/src/run_autoresearch.py summary`
...
- `autoresearch_contract.py` 会先按 `autoresearch/schemas/autoresearch-contract.schema.json` 校验 contract JSON
...
```bash
python3 autoresearch/src/run_autoresearch.py \
  init \
...
- `target_task -> target_prompt_path`
  - `context-routing-skill -> autoresearch/src/tasks/context-routing-skill-prompt.md`
  - `knowledge-base-skill -> autoresearch/src/tasks/knowledge-base-skill-prompt.md`
  - `task-contract-skill -> autoresearch/src/tasks/task-contract-skill-prompt.md`
  - `writeback-cleanup-skill -> autoresearch/src/tasks/writeback-cleanup-skill-prompt.md`
...
```bash
python3 autoresearch/src/run_skill_suite.py \
  --repo typer \
  --backend claude \
...
```bash
python3 autoresearch/src/run_backend_acceptance_matrix.py \
  --repo typer \
...
```bash
python3 autoresearch/src/run_claude_skill_eval.py \
  --repo typer \
  --task context-routing \
  --with-eval
```
...
python3 -m py_compile \
  autoresearch/src/run_autoresearch.py \
  autoresearch/src/autoresearch_feedback_distill.py \
  autoresearch/src/autoresearch_mutation_registry.py \
  autoresearch/src/autoresearch_worker_contract.py \
  autoresearch/src/autoresearch_selector.py \
  autoresearch/src/test_autoresearch_feedback_distill.py \
  autoresearch/src/test_autoresearch_mutation_registry.py \
  autoresearch/src/test_autoresearch_worker_contract.py \
  autoresearch/src/test_autoresearch_selector.py \
  autoresearch/src/test_exrepo_runtime.py \
  autoresearch/src/test_run_skill_suite.py \
  autoresearch/src/test_autoresearch_round.py \
  autoresearch/src/test_run_autoresearch.py \
  autoresearch/src/test_autoresearch_p1_1_smoke.py \
  autoresearch/src/test_autoresearch_p1_3_smoke.py \
  autoresearch/src/test_autoresearch_p2_smoke.py
```
...
- `manage_tmp_exrepos.py` 的 repo-local 维护说明见 `autoresearch/docs/runbooks/tmp-exrepo-maintenance.md`
- unified runner 与 autoresearch 主链的 CLI 边界见 `autoresearch/docs/references/research-cli-help.md`
