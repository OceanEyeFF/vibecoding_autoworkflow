...
from common import REPO_ROOT, AUTORESEARCH_SCHEMAS_ROOT, SUITES_ROOT


AUTORESEARCH_CONTRACT_SCHEMA_PATH = AUTORESEARCH_SCHEMAS_ROOT / "autoresearch-contract.schema.json"
