...
from common import REPO_ROOT, AUTORESEARCH_SCHEMAS_ROOT


AUTORESEARCH_MUTATION_REGISTRY_SCHEMA_PATH = AUTORESEARCH_SCHEMAS_ROOT / "autoresearch-mutation-registry.schema.json"
