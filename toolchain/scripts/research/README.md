...
- `manage_tmp_exrepos.py` 的 repo-local 维护说明见 `docs/autoresearch/runbooks/tmp-exrepo-maintenance.md`
- unified runner 与 autoresearch 主链的 CLI 边界见 `docs/autoresearch/references/research-cli-help.md`
