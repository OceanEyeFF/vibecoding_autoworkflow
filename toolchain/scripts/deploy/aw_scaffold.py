...
TEMPLATE_SPECS = {
    ...
    "worktrack-contract": TemplateSpec(
        ...
        required_keyed_fields_by_section=(
            ("Metadata", ("worktrack_id", "branch", "baseline_branch", "owner", "updated")),
        ),
    ),
    "worktrack-plan-task-queue": TemplateSpec(
        ...
        required_keyed_fields_by_section=(
            ("Metadata", ("worktrack_id", "updated", "current_phase")),
        ),
    ),
    "worktrack-gate-evidence": TemplateSpec(
        ...
        required_keyed_fields_by_section=(
            ("Metadata", ("worktrack_id", "updated", "gate_round")),
            ("Gate Status", ("pass", "why")),
        ),
    ),
}
