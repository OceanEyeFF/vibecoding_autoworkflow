...
- `aw_installer_cli/`：覆盖 `aw-installer` CLI 命令面，包含 help/version/无参、agents 与 claude 的 diagnose / update dry-run / check_paths_exist / prune / install / verify / update apply，以及 GitHub source Node-owned/fallback 边界和 TUI 非交互保护
