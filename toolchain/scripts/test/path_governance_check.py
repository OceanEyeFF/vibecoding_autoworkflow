...
REQUIRED_ENTRY_PATHS = [
    ...
    "product/harness/core/contracts/README.md",
    ...
    "product/harness/core/governance/README.md",
    "product/harness/core/governance/harness-governance-fields.md",
    "product/harness/core/governance/repo-governance-evaluation.contract.md",
    "product/harness/core/shared/README.md",
    "product/harness/core/shared/contract-runtime-boundary.md",
