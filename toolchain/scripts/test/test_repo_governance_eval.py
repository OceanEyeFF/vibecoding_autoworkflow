...
def test_evaluate_repo_governance_accepts_valid_payload() -> None:
    result = evaluate_repo_governance(
        {
            ...
            "evidence": {
                ...
                "change_governance": ["docs/project-maintenance/governance/review-verify-handbook.md"],
    ...
    assert result["dimensions"]["change_governance"]["evidence"] == ["docs/project-maintenance/governance/review-verify-handbook.md"]
