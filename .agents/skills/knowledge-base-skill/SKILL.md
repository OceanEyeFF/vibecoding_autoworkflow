...
1. `toolchain/skills/aw-kernel/memory-side/knowledge-base-skill/SKILL.md`
2. `toolchain/skills/aw-kernel/memory-side/knowledge-base-skill/references/entrypoints.md`
...
- Use `.agents/skills/` only as an adapter layer, never as a second memory layer.
