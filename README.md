...
- ✅ 3 个核心 Skills：`autodev` / `autodev-worktree` / `review-loop`（`Claude/skills/aw-kernel/`）
...
- **[Prompt 模板（repo-side contract）](docs/operations/prompt-templates/)** - 任务规划合同、轻量/严格执行、review-loop 与执行合同模板
