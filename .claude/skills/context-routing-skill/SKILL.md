...
1. `toolchain/skills/aw-kernel/memory-side/context-routing-skill/SKILL.md`
2. `toolchain/skills/aw-kernel/memory-side/context-routing-skill/references/entrypoints.md`
...
- Keep the same capability boundary as `.agents/skills/context-routing-skill/`.
